...
MODELS = {
    "XGBoost-delta": "../../RQ1/experiment_2/rq2_delta_default/predictions.parquet",
    "RandomForest-delta": "../experiment_4/rf_delta_default/predictions.parquet",
...
def main():
    ...
    out.to_csv("significance_test_results.csv", index=False)
    print("\nwrote significance_test_results.csv")
