...
FULL5_PATH = "full_ensemble_predictions.parquet"
LOO_DROP_TGCN_PATH = "loo_drop_T-GCN_predictions.parquet"
...
def main():
    ...
    pd.DataFrame(rows).to_csv("significance_test_full_ensemble_results.csv", index=False)
    print("\nwrote significance_test_full_ensemble_results.csv")
