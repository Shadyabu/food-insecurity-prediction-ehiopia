"""Diagnostic-only variant of build_fews_outlook_reproduction.py
(2026-09-02): same method, restricted to the 2026-01..2026-06 window --
FEWS NET's own outlook benchmark, for the exact same period the RQ2
Experiment 5 ensemble's 2026 robustness check used. Not a replacement for
the original 2020-2024 file (kept unchanged, separate output paths here).
...
def main():
    ...
    out_path = OUT_DIR / "fews_outlook_f1_2026.csv"
    ...
    df[["zone_code", "dominant_livelihood_zone", "scenario", "collection_date",
        ...
        "pred_continuous", "obs_continuous"]].to_csv(OUT_DIR / "fews_outlook_matched_rows_2026.csv", index=False)
